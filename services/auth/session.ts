 ...
 * gate, minus the HR invite-link panel — that stays with HR.
 */
export type StaffRole = "admin" | "ticketing" | "scanner";
...
const ROLES: StaffRole[] = ["admin", "ticketing", "scanner"];
 ...
 * Ticketing and scanner credentials are optional: if a pair is not configured,
